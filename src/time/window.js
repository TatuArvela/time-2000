const createWindow = () => {
  return (<div class="window" id="time-2000">
    <div class="window__title window__title--has-icon">
      <img
        src="../icons/16/application.png"
        alt="Sakura Time 2000"
        class="window__title__icon"
      />Sakura Time 2000
    </div>
    <div class="window__content">
      <div class="toolbar">
        <button
          class="toolbar__button time2k__button--new"
          id="btn-new"
        ></button>
        <button
          class="toolbar__button time2k__button--open"
          id="btn-open"
        ></button>
        <button
          class="toolbar__button time2k__button--save"
          id="btn-save"
        ></button>
        <button
          class="toolbar__button time2k__button--export"
          id="btn-export"
        ></button>
      </div>
      <div class="well">
